...
import math
# bank 数据集
dataMat, label, columnName = loadDataSet("./bank.txt", ';')
testDataMat, testLabel, testColumnName = loadDataSet("./banktest.txt", ";")
...
# newNode = buildID3Tree(newDataMat, newLabel, columnName, columnRanges)
# newNode = buildID3Tree(newDataMat, newLabel, columnName, columnRanges)
# print 'test value is '
